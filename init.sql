...
CREATE USER IF NOT EXISTS root_app WITH PASSWORD 'senha_root';
CREATE USER IF NOT EXISTS escritor_app WITH PASSWORD 'senha_escritor';
CREATE USER IF NOT EXISTS editor_app WITH PASSWORD 'senha_editor';
...
-- Permissões gerais de SELECT, INSERT, UPDATE
